...
const Footer = () => {
  ...
  return (
    <footer className="bg-dark-bg-alt border-t border-dark-border">
      {/* Back to Top Button */}
      <div className="relative">
        <button
          onClick={scrollToTop}
          className="absolute -top-6 left-1/2 transform -translate-x-1/2 w-12 h-12 bg-brand-indigo hover:bg-brand-indigo-light text-white rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-lg"
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xl font-bold text-text-primary">Aashish Ace</span>
            </div>
            <p className="text-text-secondary leading-relaxed max-w-md">
              Senior Software Engineer at Directi & Mobile App Specialist passionate about creating innovative 
          ...
          <div>
            ...
            <div className="mt-4">
              <a
                ...
                className="text-text-secondary hover:text-brand-indigo transition-colors duration-300"
              >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute bottom-0 left-1/4 w-32 h-32 bg-brand-indigo/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-1/4 w-48 h-48 bg-accent-purple/5 rounded-full blur-3xl"></div>
      </div>
    </footer>
  )
}
