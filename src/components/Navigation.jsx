  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="container-custom">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center">
            <button 
              ...
              className="text-xl font-bold text-text-primary hover:text-brand-indigo transition-colors duration-300"
            >
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <a
              href="https://www.instagram.com/aashish.ace"
              target="_blank"
              rel="noopener noreferrer"
              className="social-link"
          ...
          <div className="md:hidden">
            <button
              ...
              className="text-text-primary hover:text-brand-indigo transition-colors duration-300"
            >
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-dark-bg border-b border-dark-border">
            <div className="py-4 space-y-4">
              {navItems.map((item) => (
                <button
                  key={item.name}
                  onClick={() => scrollToSection(item.href)}
                  className="block w-full text-left px-4 py-2 text-text-secondary hover:text-text-primary transition-colors duration-300 font-medium"
                >
                  {item.name}
                </button>
              ))}
